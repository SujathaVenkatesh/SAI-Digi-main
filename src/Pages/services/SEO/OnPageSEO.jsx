...
import on_seoImg from '../../../assets/onPageSEO.jpg';
        ...
        <>
            ...
            <div className='bg-black p-5'>
                <section className="md:h-screen flex flex-col justify-center ">
                    <h2 className='text-orange-500 text-center text-3xl text-bold md:mb-[50px]'>On-Page Optimization</h2>
                    <div className="flex flex-col md:flex-row items-center ">
                        {/* Right Side: Image */}
                        <div className="w-full md:w-2/5 p-4 md:p-8 border border-orange-500 rounded-3xl">
                            <img src={on_seoImg} alt="About Us" className="w-full h-auto md:h-[400px] rounded-md" />
                        </div>
